<td valign="top" class="tdmain">
    ...
    <a href="index.php?mod=product&act=insert">
        [Add]
    </a>
    <br /><br />
    <?php
    ...
    <table width="100%" border="0">
        ...
        <tr onmouseover="this.bgColor='#D1D1D1'" onmouseout="this.bgColor='#fff'">
            ...
            <td>
                <a href="index.php?mod=product&act=edit&id=<?php echo $rows['id']; ?>"> [Edit] </a>
            </td>
            <td>
                <a onclick="return confirm('Chac chan xoa khong?')"
                    href="index.php?mod=product&act=delete&id=<?php echo $rows['id']; ?>">[Del] </a>
            </td>
        </tr>
        <?php
        }
